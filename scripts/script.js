...
function navAnimate() {
    ...
    document.getElementById("sm-main").style.paddingLeft = "20px";
}
...
let smnavId = ["sm-about-us", "sm-hackathon", "sm-downloads", "sm-speakers", "sm-sponsors",  "sm-timeline", "sm-contact-us", "sm-main", "sm-prev-events"]
let smMainPageId = [ "sm-about-us-top", "sm-hackathon-top", "sm-timeline-top", "sm-speakers-top", "sm-sponsors-top", "sm-contact-us-top", "sm-downloads-top", "sm-main-top", "sm-prev-events-top"]
